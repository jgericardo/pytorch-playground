...
export let userDatasets = {
  "linear": "linear",
  "squareroot": "square_root",
  "hyperbola": "hyperbola",
  "circle": "circle",
  "checkered2x2": "checkered_2x2",
  "checkered4x4": "checkered_4x4"
};
...
export class State {
  ...
  private static PROPS: Property[] = [
    ...
    {name: "pruningThreshold", type: Type.NUMBER},
    {name: "pruningStrategy", type: Type.STRING},
    {name: "hiddenNodes", type: Type.NUMBER},
    {name: "userDataset", type: Type.STRING, keyMap: userDatasets},
    ...
    {name: "numberOfEpochs", type: Type.NUMBER}
  ];
  ...
  hiddenNodes = 10;
  networkShape: number[] = [this.hiddenNodes, 2];
  x = true;
  y = true;
  xTimesY = false;
  xSquared = false;
